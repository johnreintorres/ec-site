    ...
    <div class="two900-section">
      ...
      <div class="two200-title-p">
        <p> 韓国コスメの中でも人気のパックやスキンケア商品を集め、選んで楽しいお得な定期コースで毎月ご自宅にお届けします。<br>
          季節限定の入荷商品から効果が高いと人気の、韓国ヘアケア商品まで、豊富なラインナップからお選びください。</p>
      </div>
    </div>
        ...
        <div class="two900-form-section">
          ...
          <div class="two900-form-cont">
            ...
            <!-- 
              ...
              <span class="prod-label">MEDIHEAL</span>
              <button><span class="prod-name">N.M.F アクアリング アンブル <br> マスク EX <span class="bold-text">【2枚セット】</span>
                </span></button>
             -->
