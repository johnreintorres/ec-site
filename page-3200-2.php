      ...
      <div class="top-selection-area">
        <div class="selection-field">
          <div class="selection-check-cont">
            <input type="checkbox" name="selection-top" id="rad1">
            <label for="rad1">手提げ袋あり(+300円)</label>
        ...
        <div class="selection-field right-field">
          <div class="selection-check-cont">
          <input type="checkbox" name="selection-top" id="rad2">
            <label for="rad2">手提げ袋無し</label>
          </div>
          <div class="selection-btn">
              ...
              <div class="radio-btn-area">
                ...
                <div class="radio-btn-group">
                  ...
                  <div class="radio-btn-output2">
                    <img src="<?php echo get_template_directory_uri();?>/assets/images/bg_wrapping2_red.png" alt="">
                  </div>
                </div>
              </div>
            </div>
